    ...
    public void buttonPressed(ButtonType button){
        ...
        switch (button) {
            case Add:
                ...
                */
                String name, lastname, street, zip, city;
                int age;
                name = view.getFirstNameText();
                lastname = view.getLastNameText();
                age = convertAge(view.getAgeText());
                street = view.getStreetText();
                zip = view.getZipCodeText();
                ...
                register.addGuest(name,lastname,age,city,street,zip,country);
            ...
            case Change:
                ...
                if (validateIndex(index)) { //validateIndex is a private method in this class
                    ...
                    if (guestToChange != null){
                        ...
                        guestToChange.setName(view.getFirstNameText());
                        ...
                        guestToChange.setZip(view.getZipCodeText());
    ...
    private void updateView(int index) {
        ...
        if(validateIndex(index)) {
            ...
            if (guest == null) {
                 ...
                 */
                view.setFirstNameText(guest.getName());
                view.setLastNameText(guest.getLastName());
                view.setAgeText(String.valueOf(guest.getAge())); //remember to convert the datatypes since age is an int in Guest
                view.setStreetText(guest.getStreet());
                view.setZipCodeText(guest.getZip());
